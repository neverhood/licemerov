class AddAvatarToUserDetails < ActiveRecord::Migration
  ...
  def self.down
    ...
    remove_column :user_details, :avatar_content_type, :string
    remove_column :user_details, :avatar_file_size, :integer
    remove_column :user_details, :avatar_updated_at, :datetime
  end
end
